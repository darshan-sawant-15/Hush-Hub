...
<head>
    ...
    <title>People Who Liked This Post</title>
    ...
    <div>
        <div class="row p-4">
            <div class="col-md-6 offset-md-3">
                ...
                $liker_ids = getLikersIDs($_GET["id"]);



                $first = true;
                if (!empty($liker_ids)) {
                    foreach ($liker_ids as $id) {
                        $user = getUserFromId($id);
                        ?>
                        <div class="card">
                            <?php if ($first) {
                                echo '<h5 class="text-center mt-4">People Who Liked This Post</h5><hr>';
                                $first = false;
                            } ?>
                            <div class="card-body d-flex align-items-center">
                                <div class="mr-4">
                                    <img src="../assets/images/uploads/profile-pictures/<?php echo $user["profile_picture"] ?>"
                                        class="rounded-circle" style="border: 1px solid #17252A;" width="75" height="75"
                                        alt="Profile Picture">
                                </div>
                                <div>
                                    <h6 class="card-title">
